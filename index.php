...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://fonts.google.com/?query=lato&selection.family=Lato:100,300,300i,400">
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="btn-app">
                        <img src="resources/img/download-app.svg" alt="App Store buttom">
                        <img src="resources/img/download-app-android.png" alt="Play Store buttom">
                    </a>
                </div>
            </div>
        </section>
                    ...
                    <form method="post" action="mailer.php" class="contact-form">
                        <div class="row">
                            ...
                            echo "<div class=\"form-messages success\">
                                Thenk you! Your message has been sent.
                            </div>"; 
                            }
                            if($_GET['success'] == -1) {
                        ...
                        <div class="row">
                            <div class="col span-1-of-3">
                                <labe for="find-us">How did you find us?</labe>
                            </div>
                            <div class="col span-2-of-3">
        ...
        <script src="//cdn.jsdelivr.net/respond/1.4.2/respond.min.js"></script> <!--Respond old browser -->
        <!--<script src="//cdn.jsdelivr.net/html5shiv/3.7.3/html5shiv-printshiv.min.js">
        </script><!--HTML old browser -->
        <!--<script src="//cdn.jsdelivr.net/selectivizr/1.0.3b/selectivizr.min.js">CSS3 old browser 
        </script>-->
        <script src="vendors/js/jquery.waypoints.min.js"><!-- waypoints section-features -->
        </script>
